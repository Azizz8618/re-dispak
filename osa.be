...
G40050	уиа	'2003'
	...
	пб	G40057-1(М17)
*
*** Переключатель работ системы БЭСМ-6 - АС-6
*** в зависимости от типа внешнего  устройства
*
...
переп	сч	Е48П41
	мод	(М16)
	зп	9(М16)
	пв	КПФШ(М14) Буфер приема переполнен
G41326	уии	М1(М10)
	пб	(М12)
**********
*
*** Прием символов 
*   вероятно с устройств, подкл. через ЭВМ ЕС
*
*М17 - ном. терминала
*М4 - номер символа в слове
*М15 - рабочий
*м14 - МОТТ
трмас6	сч	НОМФУН+3 функциональн. клавиши
	и	Е48(М17)
	по	(М15)
	нтж	НОМФУН+3
	зп	НОМФУН+3
	...
	зп	(М11)
	уи	М1
	уиа	48(М4) счетчик принимаемых символов
прием	сч	ШЗПРИМ
	и	Е48(М17)
	пе	выдача прием запрещен. Идет выдача
	сч	(М1)
	сда	64-8(М4)
	и	П377
	по	кнстр1 конец строки
	слиа	-8(М4) приняли символ (КОИ7)? Убавиили счетчик
	уиа	'2003'
	пв	рзбсмв(М14) символ на перекодировку
	зп	готсмв+1-ОСА(М13) 
	уиа	'3'
	мод	(М16)
	сч	9(М16) счетчик для цикла?
	сда	64-8
	или	готсмв+1-ОСА(М13)
	пв	ЗПСЕС1(М14) на запись символа в рекорд?
	пино	прием(М4) слово приняли
	слиа	1(М1)
	счи	М1
	сда	64-32
	нтж	(М5)
	...
	и	П377
	по	кнстр1
	уиа	48(М4) обновили счетчик для приема нового слова
	пб	прием
*
G41354	сч	НОМФУН+2
	и	D43153
...
G42643	сч	'47'(М7)
	...
	отмен	(М3)
*
*** ТЕРМИНАЛЫ ЧЕРЕЗ ПМ-6
*** вероятно тоже через АС,ТТ в ГЕНС
*
	употр	ОСА(М16)
ттас6	сч	ТУС-1+'31' из ДИСП70.дпа1
	уи	М16
ттас6а	увв	'4230' принять сигнал сост.
	зп	шктт6 - младшие 6 разрядов?
	и	мастт6
	по	БПУ
	нед	
	уи	М17
...
рзбсмв	зп	симво6
	...
	уи	М2
	мода	ТАБЛИЦ
	сч	(М2) строка в таблице
	сда	64(М6) символ в строке
кнцстр	и	П377 символ конца строки
	пб	(М14)
*
*** Разбор символа с другого типа
* устр-в
*
рзбстт	зп	симво6 2733 непонятно откуда приходим
	уиа	'2003'
	и	Е1
	уи	М4
	сч	симво6
...
D43073	пам	1
D43074	пам	1
мастт6	конд	в'0000000000177700'
шктт6	пам	1
D43077	пам	1
D43100	пам	1
D43101	пам	1
...
D43246	пам	1
D43247	пам	1
шсвоб6	конд	в'7777777777777777'
D43251	пам	1
D43252	пам	1
D43253	пам	1
D43254	пам	1
...
ТСКИФЫ	конд	п'СКИФЫ '
D43305	пам	1
ТСКИФ2	конд	п'0СКИФ2'
ТСКИФ3	конд	п'0СКИФ3'
ТСКИФГ	конд	п'СКИФГШ'
D43311	пам	1
готсмв	пам	2
D43314	пам	1
D43315	пам	1
	ВХОД	ВИХ,ЯЧВСС,D43074,D43100,D43105,G41635,G40221,зг413
БОЭК1	ВНЕШ	ЗАПВЫХ
ВЗУ	ВНЕШ	ПОК
ВИСП	ВНЕШ	ВШГП,ВШГ
