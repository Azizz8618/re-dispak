...
ВЫХОД НОП ,
 СЧ КУСПЛ
 ПВ ТБУФ(М15)
конвыд	уиа	'2003' закончили выдачу
 СЧ ШКПЛАН
 ИЛИ Е4
...
ВЫВПМ6	зп	РЯ
	...
	мода	КВИТ
	уиа	0(М15)
	мод	ТУС-1+'31' У нас здесь СВЯЗЬ7
	пв	зг413-ОСА(М16) ОС-117/А не работает ПМ-6
	мода	КВИТ+1
	уиа	0(М15)
	сч	D10305
	мод	ТУС-1+'31'
